<script lang="ts">
  ...
  const handleSubmit = async (event: Event) => {
    ...
    try {
      ...
      > & { strategy?: typeof formData.customStrategy };
      ...
      errorMessage =
        error instanceof Error ? error.message : "创建流水线任务失败";
    } finally {
      isSubmitting = false;
    }
  };
  ...
  <form on:submit={handleSubmit}>
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <select id="sourceDbId" bind:value={formData.sourceDbId} required>
      ...
      <div class="form-group">
        ...
        <select id="targetDbId" bind:value={formData.targetDbId} required>
    ...
    <div class="form-group">
      <label>
        <input type="checkbox" bind:checked={useCustomStrategy} />
        使用自定义迁移策略
      </label>
    </div>
    ...
    {#if !useCustomStrategy}
      <div class="form-group">
        ...
        <select id="strategyId" bind:value={formData.strategyId} required>
    ...
    {:else}
      <div class="custom-strategy-section">
        ...
        <div class="form-group">
          ...
          <select id="strategyType" bind:value={formData.customStrategy.type}>
